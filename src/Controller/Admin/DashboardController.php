...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::linkToCrud('Equipment', 'fas fa-shield-alt', Equipment::class);
        yield MenuItem::linkToCrud('Inventaire', 'fas fa-backpack', AdventurerEquipment::class);
        yield MenuItem::linkToCrud('Skill', 'fas fa-star', Skill::class);
